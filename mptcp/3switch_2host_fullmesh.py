...
def topology():
    ...
    net.addLink(s1, s2, intfName1='s1-eth3', intfName2='s2-eth3', bw=5)
    net.addLink(s1, s2, intfName1='s1-eth4', intfName2='s2-eth4', bw=5)

    net.addLink(s3, s1, intfName1='s3-eth1', intfName2='s1-eth5', bw=5)
    net.addLink(s3, s2, intfName1='s3-eth2', intfName2='s2-eth5', bw=5)
    ...
    c0 = net.addController('c0', ip='10.103.90.102', port=6633)
    # start s1 switch
    s1.start([c0])
    s2.start([c0])
